...
export HIPFFT_DIR=/opt/rocm-4.5.2/hipfft/
export HIPFFT_INC=${HIPFFT_DIR}/inc
export HIPFFT_LIB=${HIPFFT_DIR}/lib

export ROCMRNG_DIR=/opt/rocm-4.5.2/rocrand/
export ROCMRNG_INC=${ROCMRNG_DIR}/inc
export ROCMRNG_LIB=${ROCMRNG_DIR}/lib

export WC_GEN_OMP_SRC=/home/twang/myWork/wire-cell-gen-omp
...
#no-container
export WIRECELL_DATA=/work/zdong/git/wire-cell-data
...
export LD_LIBRARY_PATH=${WC_GEN_OMP_LIB}:${WCT}/lib:$LD_LIBRARY_PATH
