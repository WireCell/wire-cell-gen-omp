...
#include "WireCellGenOpenMP/DepoTransform.h"
...
WIRECELL_FACTORY(GenOpenMPDepoTransform, WireCell::GenOpenMP::DepoTransform, WireCell::IDepoFramer, WireCell::IConfigurable)

using namespace WireCell;
using namespace std;

GenOpenMP::DepoTransform::DepoTransform()
...
void GenOpenMP::DepoTransform::configure(const WireCell::Configuration& cfg)
{
...
WireCell::Configuration GenOpenMP::DepoTransform::default_configuration() const
{
    Configuration cfg;
