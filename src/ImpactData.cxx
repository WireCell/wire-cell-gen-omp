...
GenOpenMP::ImpactData::ImpactData(int impact)
    : m_impact(impact)
{
}
void GenOpenMP::ImpactData::add(GaussianDiffusion::pointer diffusion)
{
    m_diffusions.push_back(diffusion);
}

Waveform::realseq_t& GenOpenMP::ImpactData::waveform() const
{
    return m_waveform;
}

Waveform::compseq_t& GenOpenMP::ImpactData::spectrum() const
{
    return m_spectrum;
}

Waveform::realseq_t& GenOpenMP::ImpactData::weightform() const
{
    return m_weights;
}

Waveform::compseq_t& GenOpenMP::ImpactData::weight_spectrum() const
{
...
// std::pair<int,int> GenOpenMP::ImpactData::strip() const
// {
//     int imin=-1, imax = -1;
...
std::pair<double, double> GenOpenMP::ImpactData::span(double nsigma) const
{
    int ncount = -1;
